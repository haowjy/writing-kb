...
How Pokemon sustain themselves in this world. Author-only mechanic --- never explicitly stated in narrative; show effects only.
...
- [Pokemon Fainting Mechanics](pokemon-fainting.md) --- what happens when Pokemon faint
- [Power Scaling --- Author Guidance](power-scaling.md) --- relative strength benchmarks
- [Ranger Union](../../../organizations/ranger-union.md) --- population management role
- [Quest System & Job Boards](../trainers/quest-system.md) --- rescue work
