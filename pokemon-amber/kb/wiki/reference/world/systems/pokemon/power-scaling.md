...
Internal benchmarks for relative strength without exposing numeric levels in-text. Numbers are approximate and represent typical peak combat capability under a competent trainer. Individual variance is large.
...
**Notes on Legendaries:** Some legendaries/mythicals are weaker or niche; power judged holistically, not by number alone.
...
- [Aura and Bonds — Mechanics](../aura.md) --- aura cultivation as growth-ceiling determinant
- [Licensing System & Trainer Tiers](../trainers/licensing.md) --- tier requirements
- [Quest System & Job Boards](../trainers/quest-system.md) --- quest class definitions
