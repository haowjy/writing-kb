...
**First Documented Appearance:** [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md) - Amber discovers the job board at Celadon Pokemon Center.
...
**Examples:**
- "[Item] Berry Collection - Celadon Hills (Moderate) ₽15" ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
**Examples:**
- "[Defeat] Rogue Eevee and Eeveelutions Route 7 - Exercise Caution (Moderate) ₽80" ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
**Examples:**
- "Why were there so many about retrieving 'fainted' Pokemon left in forests?" ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md) - Amber's observation)
...
**Context - Fainted Pokemon:** When Pokemon faint, they [cannot be recalled to their Pokeballs](../pokemon/pokemon-fainting.md). Trainers sometimes panic and flee, or become injured themselves, leaving their Pokemon behind. These rescues are time-sensitive as fainted Pokemon are vulnerable to predators and exposure.

### [WANTED] Quests (Red Paper)
High-priority threats requiring immediate attention, often with substantial bounties.

**Examples:**
- "[WANTED] Thief that stole an Oddish from Celadon Gym Greenhouse (Simple) ₽50" ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
- "[WANTED] Mass Sleep Incident - Saffron City Hypno (Extreme) ₽20,000" ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))

**Typical Difficulty:** Varies by threat (Simple to Extreme), investigation skills often needed

**High Bounties:** Major public safety threats can offer enormous rewards. The Hypno incident's ₽20,000 bounty reflects its severity - a mass casualty incident in a major city ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)).
...
Every quest requires a valid [trainer license](licensing.md). Trainers present their license at reception; Pokemon Centers verify credentials before assignment.
...
**Example:** "[WANTED] Thief that stole an Oddish from Celadon Gym Greenhouse (Simple) ₽50" ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
