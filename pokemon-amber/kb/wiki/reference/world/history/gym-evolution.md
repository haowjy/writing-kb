...
The transformation of Pokemon Gyms from ancient teaching guilds to modern multi-function institutions reflects the dramatic societal changes brought by the [Pokeball Revolution](../technology/pokeball-technology.md).
...
- [Fighting Dojo](../../places/kanto/saffron/saffron-fighting-dojo.md) remains as private training hall (no official status)
...
- [Badge System](../systems/trainers/badge-system.md) - How modern badges work
- [Gym System Structure](../systems/trainers/index.md) - Current gym functions
- [Pokeball Revolution](../technology/pokeball-technology.md) - Technological catalyst
- [Celadon Gym](../../places/kanto/celadon/celadon-gym.md) - Modern example
- [Saffron Psychic Gym](../../places/kanto/saffron/saffron-psychic-gym.md) - Type transition case

## Citations

- Pre-modern system: Described in user discussion
- Pokeball Revolution impact: User worldbuilding notes
- Celadon modernization: [Chapter 5](https://github.com/haowjy/pokemon-amber/blob/main/story/ch5/chapter5.md), [Chapter 8](https://github.com/haowjy/pokemon-amber/blob/main/story/ch8/chapter8.md)
