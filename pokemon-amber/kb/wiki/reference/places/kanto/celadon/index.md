...
- Park benches (some occupied by questionable characters) ([Chapter 5](https://github.com/haowjy/pokemon-amber/blob/main/story/ch5/chapter5.md))
...
Underground station directly connected to the [Pokemon Center](celadon-pokemon-center.md) complex, with escalators leading to main lobby. Features decorative Chansey-pink support columns and mosaic artwork depicting healing berries ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)).
...
- Meowth (seen handling currency at ticket booths) ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
- Mr. Mime (working as traffic directors at metro stations) ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
- Machop (operating ticket booths with surprising precision) ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
- Pidgey (delivery services, seen carrying packages) ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))

**Park & Garden Species:**
- Oddish/Gloom (greenhouse and garden Pokemon) ([Chapters 5, 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch5/chapter5.md))
- Bellsprout/Weepinbell (gym training Pokemon)
- Vileplume (greenhouse guardians) ([Chapter 8](https://github.com/haowjy/pokemon-amber/blob/main/story/ch8/chapter8.md))
- Various Grass-type Pokemon in maintained gardens

**Surrounding Wilderness:**
- Celadon Hills (berry collection areas)
- Forest zones (Route 7 connections)
- Undocumented wild areas with Eevee populations ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md) - rogue Eeveelutions quest)
...
Amber discovers the quest system here in [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md).
...
- Route 7 maintenance
- Investigation work (Oddish theft, [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
**Observed in Story:**
- Busy commuter culture (metro system crowded with practiced efficiency) ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
- Pokemon working alongside humans accepted as normal
- Gym holds significant social prestige (Erika's influence seen in [Chapter 8](https://github.com/haowjy/pokemon-amber/blob/main/story/ch8/chapter8.md))
- Class-conscious society (certification requirements, expensive gym fees)

**Public Safety:**
- Generally safe urban environment
- Occasional incidents (Oddish theft, [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
- Gym security actively monitors facilities ([Chapter 8](https://github.com/haowjy/pokemon-amber/blob/main/story/ch8/chapter8.md))
...
- Seasonal changes (autumn colors visible in [Chapter 5](https://github.com/haowjy/pokemon-amber/blob/main/story/ch5/chapter5.md))
...
- City description and atmosphere: [Chapter 5](https://github.com/haowjy/pokemon-amber/blob/main/story/ch5/chapter5.md)
- Metro system: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Pokemon Center: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Gym complex: [Chapters 5-8](https://github.com/haowjy/pokemon-amber/blob/main/story/ch5/chapter5.md)
- Social dynamics: [Chapters 5-9](https://github.com/haowjy/pokemon-amber/blob/main/story/ch5/chapter5.md)
