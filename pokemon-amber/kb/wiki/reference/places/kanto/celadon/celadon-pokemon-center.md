...
The **Celadon Pokemon Center** is a major medical and coordination facility in [Celadon City](index.md), serving as the primary setting for Chapter 7 where Amber discovers the [quest system](../../../world/systems/trainers/quest-system.md).
...
- Quest coordination ([job board](../../../world/systems/trainers/quest-system.md))
...
Metro station directly beneath the Pokemon Center, accessed via escalators ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)).
...
**Scale:**
"The escalator deposited me into the Pokemon Center's main lobby. I had to stop myself from gasping audibly. The familiar game sprite had done nothing to prepare me for the sheer scale of it all." ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
"The bulletin board loomed before me, a maze of paper and possibility" - extensive cork board mounted prominently ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
**Fine Print:**
Posted at bottom of board: "Quest acceptance requires valid Badge from authorized Gym. Present badge card at reception." ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
**Nurse Joy:**
"A Nurse Joy-and wasn't that a trip, seeing one in person" - efficiently manages flow of trainers and Pokemon ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
Pokemon Center serves as central coordination point for [quest system](../../../world/systems/trainers/quest-system.md):
...
- [Ranger](../../../organizations/ranger-union.md) requests
...
"The morning crowd had mostly gone silent, their attention locked on our little drama" - normally bustling with activity ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
**Turning Point:**
Mary recognizes Amber from greenhouse incident, leading to investigation in [Chapter 8](https://github.com/haowjy/pokemon-amber/blob/main/story/ch8/chapter8.md).
...
- [Quest System](../../../world/systems/trainers/quest-system.md) - Coordinated here
- [Badge System](../../../world/systems/trainers/badge-system.md) - Badge cards verified here (area authorization)
- [Ranger Union](../../../organizations/ranger-union.md) - Major quest poster

## Citations

- Facility description: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Metro station access: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Job board discovery: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Quest examples: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Mary's appearance with WANTED poster: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Amber's observations and reactions: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
