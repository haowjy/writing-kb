...
- **Pokemon affinity:** Meowth / Persian
- **Region Base:** Celadon & Saffron markets (Kanto strong); Johto cousins handle textile trade
- **Type:** Merchant house (commerce, not warrior tradition or hereditary noble Council family)

## Culture & Rites

- **Coin-Binding:** daily counting ritual
- **Market Trial:** proving business acumen
- Care for their Meowth/Persian partners (treated as valued partners, not just tools)

## Signature Technique

**Silk Step** --- multi-Meowth crowd redirection for courier protection. Used to escort high-value goods through crowded markets without confrontation.

## Notable NPCs

- **Mina:** clinic reformist, genuinely cares for Pokemon
- **Kaito:** courier, pragmatic but decent
- Various merchants throughout Kanto markets
...
The Silvertails are **normal, decent merchants** --- practical but caring for their Pokemon. The family ranges from warm (Mina's compassionate clinic) to pragmatic (Kaito's efficient courier work). They:

- Treat Meowth/Persian as valued partners, not just tools
- Hold strong business ethics (most members)
- Are deeply embedded in Kanto legitimate commerce
...
- TR's organizational competence comes from Silvertail commercial and wartime logistics, networks, breeding programs, and courier knowledge
- Madame Boss is [Giovanni's](../../characters/humans/giovanni.md) mother; his father was the prior Viridian Gym Leader, not a member of an invented Viridian House
- Madame Boss retains an autonomous profit/finance faction rather than holding unquestioned authority over Giovanni
- The clan position is "she doesn't represent us, we wish she'd stop using our name" --- creates ongoing reputational tension

## Story Hooks

- Legitimate merchant favor for Amber
- Clinic help (Mina is genuinely sympathetic to struggling trainers)
- Courier services (Kaito)
- Possible ally against Team Rocket (they have grudge against TR using clan name)
- Shame/reputational concerns provide leverage

## Cross-Refs

- [Team Rocket](../team-rocket.md) --- the criminal organization founded by Silvertail's black sheep
- [Giovanni](../../characters/humans/giovanni.md) --- the product of that marriage
- [Clan System](../../world/society/clan-system.md) --- broader clan framework
