...
### Houndstone Clan --- *Growlithe / Arcanine*
...
### Sandbind House --- *Sandshrew / Sandslash*
...
### Emberfall Conservatory --- *Vulpix / Ninetales* (rare)
...
### Hearthbloom Clan --- *Teddiursa / Ursaring*
...
### Stonehand Guild --- *Geodude / Graveler / Golem*
...
### Driftroot Collective --- *Oddish → Vileplume/Bellossom* (herbalists)
...
### Stonewing Line --- *Fossil keepers (Aerodactyl/Kabutops lines)*
...
### Mindglass House --- *Abra / Kadabra / Alakazam*
...
### Bugwarden Circle --- *Caterpie / Butterfree & Beedrill* (conservationists)
...
### Nightveil Clan --- *Zubat / Golbat / Crobat* (ninja house)
...
These aren't true clans --- modern wealthy families using Pokemon for status:
...
- **Rites are methods:** body-pressure calming (Hearthhold), heat cycles (Heat Lilt), crowd redirection (Silk Step, Garden Net)
