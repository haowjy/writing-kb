...
- Quest linkage: Rangers post overflow work to Pokémon Center job boards; see [Quest System](../world/systems/trainers/quest-system.md) for contracting and pay norms.
...
Rangers function as wilderness first‑responders—closer to firefighters/paramedics than police. They are distinct from the police force (cities) and [Ace Trainers](ace-trainers.md) (military/championship roles).
...
- **5-6+ [gym badges](../world/systems/trainers/badge-system.md)** from different areas (proves area familiarity and wilderness competency)
...
- Fainted Pokemon abandoned (recover and return - see [fainting mechanics](../world/systems/pokemon/pokemon-fainting.md))
...
- See reference/world/society/crime/poaching.md for definitions and tech.
...
Rangers have limited capacity (only so many personnel) and can't handle everything simultaneously. The [quest system](../world/systems/trainers/quest-system.md) extends their reach through freelance trainers.
...
**Ranger Involvement:**
- Post quests at [Pokemon Centers](../../reference/places/kanto/celadon/celadon-pokemon-center.md)
...
**Example Ranger Quests ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)):**
...
**Proximity:** Often near [Pokemon Centers](../../reference/places/kanto/celadon/celadon-pokemon-center.md) for coordination.
...
**Authority Powers:**
- Request [badge verification](../world/systems/trainers/badge-system.md) in wilderness
...
- Less flashy than [League competitors](../world/systems/trainers/badge-system.md) (practical vs sport)
...
When [governments formed from gym councils](https://github.com/haowjy/pokemon-amber/blob/main/story/), wilderness defense was professionalized:
...
- Integration with [quest system](../world/systems/trainers/quest-system.md) (coordinate freelancers)
...
- [Quest System](../world/systems/trainers/quest-system.md) - Rangers post and coordinate quests
- [Badge System](../world/systems/trainers/badge-system.md) - Required for Ranger application (5-6+ badges)
- Police Force - Coordinate on jurisdiction boundaries
- [Pokemon Centers](../../reference/places/kanto/celadon/celadon-pokemon-center.md) - Host quest boards
- [Pokemon Fainting Mechanics](../world/systems/pokemon/pokemon-fainting.md) - Why rescue quests exist

## Story References

While Rangers haven't appeared directly in Chapters 1-9, they are frequently referenced:

- Quest system coordination ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
- "[Ranger Request]" quests on job board ([Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md))
...
- Quest system references: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
- Ranger Request examples: [Chapter 7](https://github.com/haowjy/pokemon-amber/blob/main/story/ch7/chapter7.md)
