...
- Alexander comes from **Argaea**, a pocket region sealed from the ordinary
  Pokemon world for about 3,000 years.
...
Existing saga planning introduces Alexander before Visit 1, alongside Alonso.
The exact circumstances of his original escape from Argaea, how long he has
been outside, what he knows about the barrier, and whether his actions helped
cause a breach are not settled.
...
- How did Alexander first escape, and what role, if any, did that event play in
  the original breach?
- What is his exact age, upbringing, and political position within Argaea's
...
- [Argaea saga thread](../../../planning/saga-threads/argaea.md)
- [Hidden Kingdom arc](../../../planning/arcs/10-argaea-kitakami/overview.md)
- [Saga overview](../../../planning/saga-overview.md)
- [Darkrai and Cresselia](../../world/phenomena/legendaries/darkrai-cresselia.md)
