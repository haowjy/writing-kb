...
| Area | Purpose |
|---|---|
| [Saga overview](saga-overview.md) | Full structural map |
| [Saga threads](saga-threads/index.md) | Story-level unresolved throughlines |
| [Arcs](arcs/index.md) | Numbered arc plans and local subplots |
