...
### If Time Loop Chosen:
- Create detailed `wiki/planning/arcs/04-4ever/overview.md` plan
...
- If loop chosen: `wiki/planning/arcs/04-4ever/overview.md`
- Arc structure: `[retired arc plan]`, `[retired arc plan]`
