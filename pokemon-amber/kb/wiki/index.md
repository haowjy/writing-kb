...
Author-facing knowledge for Pokemon: Ambertwo. The primary boundary is between
**reference** (what is true about the world) and **planning** (what may happen in
unwritten story).
...
| Page | Purpose |
|---|---|
| [Saga overview](planning/saga-overview.md) | Full future-story architecture |
| [Amber](reference/characters/humans/amber-mc.md) | Protagonist reference |
| [Timeline](continuity/timeline.md) | Cross-story chronology |
| [Vocabulary](vocab.md) | Stable project terms |
...
| Arc | Folder |
|---|---|
| 0 | [The Perfect Family](planning/arcs/00-perfect-family/overview.md) |
| 1 | [Kanto Year 1](planning/arcs/01-kanto-year-1/overview.md) |
| 2 and 6 | [Celadon](planning/arcs/02-06-celadon/overview.md) |
| 4 | [4Ever](planning/arcs/04-4ever/overview.md) |
| 7-9 | [Hoenn](planning/arcs/07-09-hoenn/overview.md) |
| 10 | [Argaea: Kitakami](planning/arcs/10-argaea-kitakami/overview.md) |
| 14 | [Dimensional Displacement / Alola](planning/arcs/14-dimensional-displacement-alola/overview.md) |
| 16 | [Argaea: Deliberate Return](planning/arcs/16-argaea-return/overview.md) |

Local notes now live with their arcs: forged documents and the Giovanni/Fuji
jail scene under Arc 0; Saffron rivalry and Ursaring rescue under Arc 1;
Pikachu handoff under Arc 10; dimensional-displacement mechanics under Arc 14.
