...
### 1. Ditto
- Foundational bond, mirror, comfort, identity
...
This is a direct consequence of the departure change: a kid who leaves with a mentor's blessing has resources. A kid who runs away with nothing doesn't.

---

## Badge Pacing

- **Goal:** 8 Kanto gym badges + junior conference entry
- **Reality:** She doesn't hit 8 in Year 1 because weird incidents/Team Rocket disruptions keep pulling her off the gym circuit
- The gap between "normal trainer journey plan" and "weird stuff keeps happening" IS the story
- Exact number of badges achieved in Year 1: **TBD** (open question)
- Conference entry may happen Year 1 (with fewer badges) or Year 2

---

## Tone

- **Semi-lighthearted adventure** with darkness (Team Rocket) looming in background
- This matches the tone of chapters 1-17: serious emotional core wrapped in dry humor
- Amber's voice: semi-sarcastic, semi-serious, dry, slightly detached, observant
- Not loud quipping --- low-key humor and understated reactions
- Fun, adventurous, character-driven, open-air

---

## Weird Plot Involvement

Amber is **NOT a chosen protagonist.** She keeps getting pulled into unusual Pokemon incidents because:
- She is unusually good with Pokemon
- Pokemon with problems trust her
- She cannot easily walk away once she sees a Pokemon situation
- Her team/behavior gradually makes her visible to bad actors
- She becomes a collector of story-heavy intersections through **choices and temperament**, not fate
...
|---------|--------------|
| Trapinch as second Pokemon | Charcadet + Heracross |
| Trauma departure (fleeing Delia) | Licensed, Oak-supported departure |
...
- **Kyle Kong** --- Fighting Dojo heir, tactically weak but physically strong, Sabrina rivalry, reluctant friendship with Amber. Context/dynamics updated but core character valid.
- **Saffron Gym politics** --- Fighting Dojo vs Psychic Gym, Kyle as proxy
- **Team Rocket** --- escalating background threat, surveillance of Amber/Ditto
- **Oak** --- supportive mentor (upgraded from distant surveillance to active support)
